...
import { shuffle_array } from "./array";
 ...
 */
 export const profile: ProfileInfo = {
    ...
    about: 'I decided to be a developer in 2008. Wrote my first program.. I fell in love with coding!\n\nIn 2013 I started working at Nordcurrent, collecting experience since then..\n\nThats it for now, thanks.',
    full_name: 'Aurimas Prusovas',
    description_longer: 'This is me and I like to make random stuff 😅 to improve skills like ',
    picture: "/img/profile.jpg",
    picture_bg: "/img/profile_bg.png",
    favourite_emoji: '🍺',
    experience_started: new Date('2013-01-17'),
    urls: {
